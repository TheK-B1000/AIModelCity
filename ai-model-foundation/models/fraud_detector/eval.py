"""
Evaluation entrypoint for fraud_detector. Called by foundation eval harness.
"""
...
def run_eval(
    ...
    **kwargs,
    ...
    """Load model and eval data, return metrics dict."""
    import pandas as pd
    ...
    return {"metrics": {"accuracy": accuracy, "auc": auc}}
